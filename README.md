# Praxis-FInal---Ellis-Downs
This is my final for 450C.
...
```python
def offset_mean(data, target_mean_value):
    """Return a new arraycontaining the original data with its mean offset to match the desired value"""
    return(data - numpy.mean(data)) + target_mean_value
```
...
```
    ...
    <ipython-input-13-1c763954127a> in normalize_rectangle(rect)
...
```
    ...
    <ipython-input-16-83721d2716e7> in <module>
...
def fahr_to_celsius(temp):
    ...
    # a new variable. This code does the same as teh previous function but it is more 
    # explixit in explaining how the return command works. 
    return ((temp -32) * (5/9))
```
...
```
    ...
    <ipython-input-32-eed2471d229b> in <module>
